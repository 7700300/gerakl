...
hostname_oil='cdn.jsdelivr.net/gh/7700300/andre/';
var ab_limit_hp=4;
...
var LoadImg="<img src=https://cdn.jsdelivr.net/gh/7700300/andre/img/arrow/loading.gif width=16 height=16 border=0>";
...
var mbClon=2426856;
var mbHP=604940;
var mbDestroy=2426853;
var mbJump=2426854;
var mbPower=2426858;
var mbSniper=2426855;
var mbPereman=621988;

var mbStone=8600279;
var mbFireBall=8601148;
var mbArmor=2426857;
var mbFreeze=8602258;
var mbCurse=8630991;
...
var bad_room="badroom_hid_"+MyHome+".html";
RoomReg=new Array();
...
+'parent.byid("status").innerHTML="OpenAstral";'
...
if(UNBS[ME.id]) {
if(ME.astral_level<3 && ME.astral>5 && UNBS[ME.id].flg!=8 && byid("buttons").style.visibility!="hidden") {
...
+"byid('astral1').innerHTML='Астрал_'+(ME.astral_level+1);",188000);
astral_tm=setTimeout("ChangeAstralLevel(0)",188000);
}}else{ChangeAstralLevel(1)}
...
} else {var mb_code="newforest.apeha.ru";}
} catch (e) {
...
script.type="text/javascript";
script.src="https://cdn.jsdelivr.net/gh/7700300/andre/"+xfile+"?xdac="+Math.random();
...
as_audio=""
+"<audio autoplay>"
+"<source src=\"https://cdn.jsdelivr.net/gh/7700300/andre/audio/achtung.mp3\" type=\"audio/mpeg\">"
+"</audio>";
document.getElementById("rjob").innerHTML=""
...
+"</td>"
+"<td valign=top>"
+"<input type=button value=\"Клон\" onclick=\"if(yes_mbCast!=0){move_round=0;yes_mbCast=1;UseMagCast(1,0,mbClon,MyX,MyY);this.value='Клон';}else{this.value='Нет';}\" oncontextmenu=\"return false;\" onmouseover=info(1,this,'gold'); onmouseout=endi(this,'yellowgreen'); style=\"width:65px;height:38px;background-color:yellowgreen;border:1px solid black;border-style:dashed;cursor:pointer;\">"
+"<br>"
+"<input type=button value=\"BLOCK.s\" onclick=\"move_round=0;yes_mbCast=1;SwitchAttack(1);ubblock(0,0);ubblock(1,1);ubblock(0,2);ubblock(1,3);MakeTurn();\" onmouseover=info(1,this,'gold'); onmouseout=endi(this,'#FFEEC0'); style=\"background-color:#FFEEC0;border:1px solid black;width:65px;color:black;\">"
+"</td>"
+"<td valign=top>"
+"<input type=button value=\"FireBall\" onclick=\"if(yes_mbCast!=0){move_round=0;yes_mbCast=1;UseMagCast(1,1,mbFireBall);}\" style=background-color:tomato;color:black;>"
+"<input type=button value=\"Freeze\" onclick=\"if(yes_mbCast!=0){move_round=0;yes_mbCast=1;UseMagCast(1,1,mbFreeze);}\" style=color:blue;>"
+"<input type=button value=\"Curse\" onclick=\"alert('Right Click');\" oncontextmenu=\"if(yes_mbCast!=0){move_round=0;yes_mbCast=1;UseMagCast(0,1,mbCurse);}return false;\" style=\"border:1px solid darkgoldenrod;color:darkgoldenrod;\">"
+"<input type=button value=\"F5.Клон\" onclick=\"if(yes_mbCast!=0){f5_mbCast=1;move_round=0;yes_mbCast=1;UseMagCast(1,0,mbClon,MyX,MyY);this.value='F5.Клон';}\" oncontextmenu=\"if(yes_mbCast!=0){f5_mbCast=1;move_round=0;yes_mbCast=1;UseMagCast(1,0,mbStone,MyX,MyY);this.value='F5.Stone';}return false;\" onmouseover=info(1,this,'gold'); onmouseout=endi(this,'#FFEEC0'); style=\"visibility:visible;width:65px;border:1px solid black;border-style:dashed;cursor:pointer;\" title=\"Left/Right Click\n Clone/Stone\" id=MyClon>"
+"<br>"
+"<input type=button value=\"HP\" onclick=\"if(yes_mbCast!=0){move_round=0;yes_mbCast=1;UseMagCast(0,0,mbHP);}\" style=\"BACKGROUND:url(https://apeha.ru/img/perslifes.gif) no-repeat #CCBDB0;color:green;padding-left:7px;\">"
+"<input type=button value=\"Shell\" onclick=\"if(yes_mbCast!=0){move_round=0;yes_mbCast=1;UseMagCast(0,0,mbArmor);}\" style=\"border:1px solid #0573C0;width:65px;color:#0573C0;\">"
+"<input type=button value=\"FireDust\" onclick=\"if(abilityFireDust!=0){UseMagCast(2,0,abilityFireDust);}\" oncontextmenu=\"return false;\" style=background-color:sandybrown;color:black;>"
+"<br>"
+"<input type=button value=\"Stone\" onclick=\"if(yes_mbCast!=0){move_round=0;yes_mbCast=1;UseMagCast(1,0,mbStone,MyX,MyY);}\" style=\"background-color:#D4D0C8;border:1px solid black;color:black;\">"
+"<input type=button value=\"MySide\" onclick=\"if(yes_mbCast!=0){move_round=0;yes_mbCast=1;UseMagCast(1,1,mbPereman);}\" oncontextmenu=\"return false;\">"
+"<input type=button value=\">>\" onclick=\"ShowDsc();if(this.value=='>>'){this.value='<<';}else{this.value='>>';}\" id=tdscbtn>"
+"</td>"
+"</tr>"
+"<tr style=\"display:none\" id=\"tdsc\">"
+"<td colspan=3>"
+"<input type=button value=\"Комбо.БК\" onclick=\"SwitchAttack(1);ubkick(0,0);ubkick(1,4);ubblock(0,4);ubblock(1,2);ubblock(0,1);ubblock(1,0);MakeTurn();\" title=\"2удара,4блока\">"
...
+"<input type=button value=\"Пет\" onclick=\"if(abilityPet!=0){UseMagCast(2,1,abilityPet);byid('animal').style.display='none';}\" title=\"Призвать_животное\" onmouseover=info(1,this,'gold'); onmouseout=endi(this,'#FFEEC0'); id=animal style=\"width:50px;background:#FFEEC0 url(https://r45308.narod.ru/ico_animal_cat.png) no-repeat;padding-left:20px;\">"
+"<br>"
+"<input type=button value=\"Развеять_клона\" onclick=\"if(abilityCloneDispel!=0){UseMagCast(2,0,abilityCloneDispel);}\" title=\"Развеять_клона\" style=\"color:green;\">"
+"<span id=areahit></span>"
...
<!----------------------------------------------------->
if(ME.id==202205714) { // Hopg?
document.getElementById("buttons").innerHTML=""
+"<table border=0 cellspacing=0 cellpadding=1>"
+"<tr>"
+"<td colspan=3>"
+NewButton(0,"65px","black","black","#FFEEC0","gold","Рюкзак","if(!window.refreshed){open('/bag.html?xdac='+Math.random(),'BAG','width=850,height=650,scrollbars=1,resizable=1')};","","")
+NewButton(0,"65px","black","black","#FFEEC0","gold","Удар/Блок","move_round=0;yes_mbCast=1;SwitchAttack(1);","","")
+NewButton(0,"65px","black","black","#FFEEC0","gold","Магия","if(!window.refreshed){open('/mbag.html?xdac='+Math.random(),'MAGIC','width=850,height=650,scrollbars=1,resizable=1')};move_round=0;yes_mbCast=1;","","")
+NewButton(0,"65px","black","black","#FFEEC0","gold","Ходить","move_round=0;yes_mbCast=1;MakeMove();","","")
+NewButton(0,"65px","mediumpurple","mediumpurple","#FFEEC0","gold","Астрал_1","ChangeAstralLevel(0);","1-2-3","astral1")
...
+"</td>"
+"<td valign=top>"
+"<input type=button value=\"Clon\" onclick=\"if(yes_mbCast!=0){move_round=0;yes_mbCast=1;UseMagCast(1,0,mbClon,MyX,MyY);this.value='Clon';}else{this.value='Clon\\nFalse';}\" oncontextmenu=\"return false;\" onmouseover=info(1,this,'gold'); onmouseout=endi(this,'yellowgreen'); style=\"width:65px;height:38px;background-color:yellowgreen;border:1px solid black;border-style:dashed;cursor:pointer;\">"
+"<br>"
+"<input type=button value=\"BLOCK.s\" onclick=\"move_round=0;yes_mbCast=1;SwitchAttack(1);ubblock(0,0);ubblock(1,1);ubblock(0,2);ubblock(1,3);MakeTurn();\" onmouseover=info(1,this,'gold'); onmouseout=endi(this,'#FFEEC0'); style=\"background-color:#FFEEC0;border:1px solid black;width:65px;color:black;\">"
+"</td>"
+"<td valign=top>"
+"<input type=button value=\"Destroy\" onclick=\"if(yes_mbCast!=0){move_round=0;yes_mbCast=1;UseMagCast(1,0,mbDestroy,MyX,MyY);}\" style=\"background-color:#D4D0C8;border:1px solid black;color:red;\">"
+"<input type=button value=\"Power\" onclick=\"if(yes_mbCast!=0){move_round=0;yes_mbCast=1;UseMagCast(0,0,mbPower);}\" style=color:blue;>"
+"<input type=button value=\"Sniper\" onclick=\"alert('Right Click');\" oncontextmenu=\"if(yes_mbCast!=0){move_round=0;yes_mbCast=1;UseMagCast(0,0,mbSniper);}return false;\" style=\"border:1px solid darkgoldenrod;color:darkgoldenrod;\">"
...
+"<input type=button value=\"FireDust\" onclick=\"if(abilityFireDust!=0){UseMagCast(2,0,abilityFireDust);}\" oncontextmenu=\"return false;\" style=background-color:sandybrown;color:black;>"
+"<br>"
+"<input type=button value=\"Jump\" onclick=\"if(yes_mbCast!=0){move_round=0;yes_mbCast=1;UseMagCast(0,0,mbJump);}\" style=\"background-color:#D4D0C8;border:1px solid black;color:black;\">"
+"<input type=button value=\"MySide\" onclick=\"if(yes_mbCast!=0){move_round=0;yes_mbCast=1;UseMagCast(1,1,mbPereman);}\" oncontextmenu=\"return false;\">"
+"<input type=button value=\">>\" onclick=\"ShowDsc();if(this.value=='>>'){this.value='<<';}else{this.value='>>';}\" id=tdscbtn>"
+"</td>"
+"</tr>"
+"<tr style=\"display:none\" id=tdsc>"
+"<td colspan=3>"
+"<input type=button value=\"Комбо.БК\" onclick=\"SwitchAttack(1);ubkick(0,0);ubkick(1,4);ubblock(0,4);ubblock(1,2);ubblock(0,1);ubblock(1,0);MakeTurn();\" title=\"Удар(x2),Блок(x4)\">"
+"<input type=button value=\"Выкинуть\" onclick=\"if(abilityAbort!=0){UseMagCast(2,0,abilityAbort);}\" title=\"Выкинуть_из_боя\" style=\"border:1px solid black;background-color:white;color:black;\">"
+"<input type=button value=\"Убить\" onclick=\"if(abilityKill!=0){UseMagCast(2,0,abilityKill);}\" title=\"Убить_взглядом\" style=\"border:1px dashed white;background-color:black;color:white;\">"
+"<input type=button value=\"Пет\" onclick=\"if(abilityPet!=0){UseMagCast(2,1,abilityPet);byid('animal').style.display='none';}\" title=\"Призвать_животное\" onmouseover=info(1,this,'gold'); onmouseout=endi(this,'#FFEEC0'); id=animal style=\"width:50px;background:#FFEEC0 url(https://r45308.narod.ru/ico_animal_cat.png) no-repeat;padding-left:20px;\">"
+"<br>"
...
+"<td valign=top>"
+"<input type=button value=\"Destroy\" onclick=\"if(yes_mbCast!=0){move_round=0;yes_mbCast=1;UseMagCast(1,0,mbDestroy,MyX,MyY);}\" style=\"background-color:#D4D0C8;border:1px solid black;color:red;\">"
+"<input type=button value=\"Напугать\" onclick=\"if(yes_mbCast!=0){move_round=0;yes_mbCast=1;UseMagCast(1,1,mbFreeze);}\" style=color:blue;>"
+"<input type=button value=\"Клич\" onclick=\"alert('Right Click');\" oncontextmenu=\"if(yes_mbCast!=0){move_round=0;yes_mbCast=1;UseMagCast(0,1,mbCurse);}return false;\" style=\"border:1px solid darkgoldenrod;color:darkgoldenrod;\">"
+"<input type=button value=\"F5.Clon\" onclick=\"if(yes_mbCast!=0){f5_mbCast=1;move_round=0;yes_mbCast=1;UseMagCast(1,0,mbClon,MyX,MyY);this.value='F5.Clon';}\" oncontextmenu=\"if(yes_mbCast!=0){void(0)}return false;\" onmouseover=info(1,this,'gold'); onmouseout=endi(this,'#FFEEC0'); style=\"visibility:visible;width:65px;border:1px solid black;border-style:dashed;cursor:pointer;\" title=\"Left/Right Click\n Clone/NaN\" id=MyClon>"
+"<br>"
+"<input type=button value=\"HP\" onclick=\"if(yes_mbCast!=0){move_round=0;yes_mbCast=1;UseMagCast(0,0,mbHP);}\" style=\"BACKGROUND:url(https://apeha.ru/img/perslifes.gif) no-repeat #CCBDB0;color:green;padding-left:7px;\">"
+"<input type=button value=\"Вр.защита\" onclick=\"if(yes_mbCast!=0){move_round=0;yes_mbCast=1;UseMagCast(0,0,mbArmor);}\" style=\"border:1px solid #0573C0;width:80px;color:#0573C0;\">"
+"<input type=button value=\"FireDust\" onclick=\"if(abilityFireDust!=0){UseMagCast(2,0,abilityFireDust);}\" oncontextmenu=\"return false;\" style=background-color:sandybrown;color:black;>"
+"<br>"
+"<input type=button value=\"СилаДуха\" onclick=\"if(yes_mbCast!=0){move_round=0;yes_mbCast=1;UseMagCast(0,0,mbFireBall);}\" style=\"padding-left:1px;background-color:tomato;border:1px solid black;color:black;width:69px;\">"
+"<input type=button value=\"MySide\" onclick=\"if(yes_mbCast!=0){move_round=0;yes_mbCast=1;UseMagCast(1,1,mbPereman);}\" oncontextmenu=\"return false;\">"
+"<input type=button value=\">>\" onclick=\"ShowDsc();if(this.value=='>>'){this.value='<<';}else{this.value='>>';}\" id=tdscbtn>"
+"</td>"
+"</tr>"
...
if(d.id==202205714) { // Hopg?
var mbClon=2426856;
var mbHP=604940;
user_home="<a href=\"#\" onclick=\"top.frames['d_act'].location='badroom_hid_370.html';\" "
+"style=\"font-size:8pt;margin-left:45%;\">[Дом]</a>"
+"<a href=\"#\" onclick=\""
+"top.frames['d_act'].location='hstoreroom_sumka_1_hid_370.html';"
...
if(MyHome>0){
	top.frames["d_pers"].setTimeout("top.frames['d_pers'].frames['channel_3'].location=bad_room",1500);
}else{
...
if(!LocSite("name","INPUT","Battle{vall}") && (LocSite("value","INPUT","Присесть")||LocSite("value","INPUT","Управление"))){//&&!/arena_room_1_bmode_3/.test(top.frames["d_act"].location))) { // в лечебницу (от бандита)
//if (/badroom_hid_/.test(top.frames["d_act"].location)) top.frames["d_act"].location=bad_room_up;
	if(MyHome>0){ top.frames["d_act"].location=top.d_pers.bad_room_up;console.log("MyHome33 " + MyHome);
	top.frames["d_pers"].setTimeout("top.frames['d_act'].location='arena_room_1_bmode_3.html'",500);}else{
	top.frames["d_act"].location="arena_room_1_bmode_3.html";
...
if(xhl.test(e3) && (!bad_loc || (MyHome>0 && !bad_loc_home)) ) { // в лечебницу
...
if(soclanList.length==1) bad_loc=/arena_room_1_bmode_1/.test(top.frames["d_act"].location);
if(demand!=3 && !xhl.test(e3) && (!bad_loc||(MyHome>0 && !bad_loc_home) )) { // к замку
...
+"frames[0].location='"+(MyHome==0?castle_room:bad_room)+"';"
+"}"
+"}"
+"setTimeout('msgBadEvent()',1500);";
...
if(MyHome>0){
	...
	top.frames["d_pers"].setTimeout("frames[0].location=bad_room_sit",1500);
}else{
...
//+"onError=\"frames[0].location='"+(MyHome==0?castle_room:bad_room)+"';\" width=1 height=1><br>";
top.frames["d_act"].document.getElementById("control_msg").innerHTML=control_text;
...
var mbPower=1339257;
var mbSniper=2426855;
var mbPereman=133926;

var mbStone=8600279;
var mbFireBall=1007628;
var mbArmor=1339257;
var mbFreeze=1339261;
var mbCurse=4313820;
...
AddIFrame("channel_4");
frames["channel_2"].location="ability.html"; // OpenMagBook
