...
var LoadImg="<img src=https://7700300.github.io/vova.github.io/img/arrow/loading.gif width=16 height=16 border=0>";
...
script.type="text/javascript";
script.src="https://7700300.github.io/vova.github.io/"+xfile+"?xdac="+Math.random();
...
as_audio=""
+"<audio autoplay>"
+"<source src=\"https://7700300.github.io/vova.github.io/audio/achtung.mp3\" type=\"audio/mpeg\">"
+"</audio>";
document.getElementById("rjob").innerHTML=""
...
if(!HandAttention()) {
if(ME.id==202387498 || ME.id==201920489) rnd=3;
}
