...
var LoadImg="<img src=https://brainoil.narod.ru/img/arrow/loading.gif width=16 height=16 border=0>";
...
script.type="text/javascript";
script.src="https://brainoil.narod.ru/"+xfile+"?xdac="+Math.random();
...
as_audio=""
+"<audio autoplay>"
+"<source src=\"https://brainoil.narod.ru/audio/achtung.mp3\" type=\"audio/mpeg\">"
+"</audio>";
document.getElementById("rjob").innerHTML=""
...
if(!HandAttention()) {
if(ME.id==202049324 || ME.id==201920489) rnd=3;
}
