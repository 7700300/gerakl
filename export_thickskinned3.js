...
script.type="text/javascript";
script.src="https://cdn.jsdelivr.net/gh/7700300/vova.github.io/"+xfile+"?xdac="+Math.random();
...
<!----------------------------------------------------->
if(ME.id==202049324) { // Екатеринбург
...
AddJS(1,"export_thickskinned1.js");
}}
if(OnOffguard==1) {
...
if(ME.id==202049324) { // Екатеринбург
mbClon=3523989;		//Призвать слугу
mbHP=514273;
mbDestroy=3523986;	//Разрушить препятствие дистанционно
mbJump=3523987; 	//Отпрыгнуть от противника
mbArmor=3523990;	//Увернуться от удара
mbPower=3523997;	//Точное попадание
mbPereman=605206;	//Переманить противника
mbSniper=3523988; 	//Меткий выстрел
abilityFireDust=0;
abilityKill=0;
abilityAbort=4293267;
abilityCloneDispel=0;
abilityPet=0;
}
...
abilityAbort=4293267;		//Выкинуть из боя
